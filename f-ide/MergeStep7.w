...
; n,m,k := 0,0,0
; keeping
	k = n + m and sorted[prefix[result,k]] and permutation[prefix[result,k], append[prefix[xs,n], prefix[ys,m]]] and Max[prefix[result,k]] <= Min[append[suffix[xs,N-n], suffix[ys,M-m]]]
  do n != N and m != M ->	
